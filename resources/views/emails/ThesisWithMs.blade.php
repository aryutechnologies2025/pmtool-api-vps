...
<body style="font-family: Arial, sans-serif; color: #333;">
    ...
    <p><span style="font-weight:bold;">Payment Schedule:</span>2 Dues</p>
    <p style="margin-left: 40px;">
    <strong>Advance Payment:</strong> {{ $details['advance_payment'] }} {{ $details['advancePendingCheck'] }}<br>
    <strong>Second Payment:</strong> {{ $details['partial_payment'] }} {{ $details['partialPendingCheck'] }}<br>
    <strong>Final Payment:</strong> {{ $details['final_payment'] }}<br>
    
    <p>Disclaimer Link - want to open and agreed by the client that should come back as a reply to us</p>
