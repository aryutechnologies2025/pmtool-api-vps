...
<body style="font-family: Arial, sans-serif; color: #333;">
    ...
    <p>We provide support for 30 days following the delivery of the statistics, extension of time incurs an additional fee of 50%</p>
    <p>Requirements: Master sheet Excel, Protocol, Parent Paper, Requirements</p>
    <p>Corrections in the master sheet must be highlighted</p>
    <p>If, changing to a new master sheet after the statistics are delivered will cost 50% extra</p>
